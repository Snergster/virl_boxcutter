...
Virl_boxcutter is a self-contained 'launcher' virtual machine image, used to bring up a VIRL Server on the Packet.net platform. The launcher uses Vagrant (from Hashicorp) to control the operation of the 'launcher VM'. 
